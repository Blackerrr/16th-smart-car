...
void icm20602_init_spi(void)
{
    ...
    icm_spi_w_reg_byte(ICM20602_SMPLRT_DIV,     0x01);            //采样速率 SAMPLE_RATE = INTERNAL_SAMPLE_RATE / (1 + SMPLRT_DIV) 1000 / 2 = 500
    icm_spi_w_reg_byte(ICM20602_GYRO_CONFIG,    0x18);            //±2000 dps      16.4 LSB/dps
    icm_spi_w_reg_byte(ICM20602_ACCEL_CONFIG,   0x00);            //±2g            16384.0 LSB/g
    icm_spi_w_reg_byte(ICM20602_ACCEL_CONFIG_2, 0x26);            //0x03 Average 4 samples   44.8HZ   //0x23 Average 16 samples //0x26 Average 8 samples   5.1HZ
}
